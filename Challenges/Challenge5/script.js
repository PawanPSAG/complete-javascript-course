...
players. So create a new array ('players1Final') containing all the original
team1 players plus 'Thiago', 'Coutinho' and 'Perisic' 
5. Based on the game.odds
object, create one variable for each odd (called 'team1', 'draw' and 'team2') 
6.
...
console.log(
  `For ${game.team1} Goolkeeper ${gk} and FieldPlayers ${fieldPlayers}`
);
console.log(
  `For ${game.team2} Goolkeeper ${gk} and FieldPlayers ${fieldPlayers}`
);

const players1Final = ["Thiago", "Coutinho", "Perisic", ...players1];
console.log(`Final Team ${players1Final}`);
*/
console.log("start");
